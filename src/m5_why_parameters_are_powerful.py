...
#    even_better_draw_circles(rg.Point(-100,100),20,'blue',4,4)
#    even_better_draw_circles(rg.Point(100,-100),10,'pink',1,8)
    draw_circles(rg.Point(-100,-100))
    draw_circles(rg.Point(100,-100))
    better_draw_circles(rg.Point(0,100),3)
    even_better_draw_circles(rg.Point(100,100),10,'magenta',1,10)
    even_better_draw_circles(rg.Point(-100, 100), 10, 'magenta', 1, 10)
...
def even_better_draw_circles(point,radius,color,size,number_of_circles):
    ...
    for k in range(1, number_of_circles):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(radius * k)  # Radius chosen
